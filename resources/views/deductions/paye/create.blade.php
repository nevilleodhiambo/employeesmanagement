...
@section('content')
        ...
        <div class="col-sm-12 col-xl-6 p-5">
            ...
            <div class="bg-light rounded h-100 p-4">
                ...
                <form method="POST" action="{{route('paye.store')}}">
                    @csrf
                <div class="form-floating mb-3"> 
                    <input type="number" class="form-control" id="floatingInput" name="low_income" value="{{old('low_income')}}"
                ...
                <div class="form-floating mb-3"> 
                    <input type="number" class="form-control" id="floatingInput" name="high_income" value="{{old('high_income')}}"
                ...
                <div class="form-floating mb-3"> 
                    <input type="text" class="form-control" id="floatingInput" name="rates" value="{{old('rates')}}"
